...
namespace InfluencersApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Also injecting the connection string from the configuration           

            services.AddDbContext<InfluencersContext>(
                options => options.UseSqlServer(Configuration.GetConnectionString("Default")));
           
            services.AddInfluencersStores();
